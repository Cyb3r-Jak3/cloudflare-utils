...
function __cloudflare-utils_perform_completion
    ...
    for line in $results
        if not string match -q -- "cloudflare-utils*" $line
...
# Clear existing completions for cloudflare-utils
complete -c cloudflare-utils -e
# Register completion function
complete -c cloudflare-utils -f -a '(__cloudflare-utils_perform_completion)'
